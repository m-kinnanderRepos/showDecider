export function createMostPopularGrid(mostPopularInfo) {
  ...
  if (typeof mostPopularInfo != "undefined"){
    for(let i = 0; i < mostPopularInfo['tv_shows'].length; i++){
      ...
      list_items = list_items + `<div class="image" permalink=${mostPopularInfo['tv_shows'][i]['permalink']} id="mostpop" style="background-image: url(&quot;${mostPopularInfo['tv_shows'][i]['image_thumbnail_path']}&quot;);">`
