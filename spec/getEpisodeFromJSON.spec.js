...
describe("getEpisode", function() {
    ...
    describe("When episode index is equal to 0", function(){
      it("getEpisode should return episode 1 from season 1", function() {
        expect(getEpisode(arrow, 0)).toEqual(arrow['tvShow']['episodes'][0]);
      });
